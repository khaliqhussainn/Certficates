          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mr-3">
                <span className="text-[#001e62] font-bold text-sm">CP</span>
              </div>
              <span className="text-xl font-bold">CertifyPro</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Earn industry-recognized certificates through secure, proctored online exams. 
              Validate your skills with blockchain-verified credentials that employers trust.
            </p>
